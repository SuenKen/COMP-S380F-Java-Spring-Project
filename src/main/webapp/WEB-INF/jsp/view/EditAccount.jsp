    ...
    <div class="w3-right w3-hide-small">
        ...
        <div class="w3-content w3-padding" style="max-width:1564px">
            ...
            <div class="w3-container w3-padding-32" id="about">
                <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Edit Account</h3>
                <p>  
                    <form:form method="POST" 
                               modelAttribute="users" action="edit">
                        <form:label path="username" >Username</form:label><br/><br/>
                        <form:input type="text" path="username"  readonly="true" class="w3-input w3-border"/><br/>
                        ...
                        <form:checkbox path="roles" value="ROLE_ADMIN" style="width:50px;transform: scale(1.5)"/>Admin<br/>

                        <input type="submit" value="Edit User" class="w3-button w3-black w3-section"/>
                        <a href="<c:url value="/admin/account/view" />" class="w3-button w3-black w3-section">Back</a>
                    </form:form>
