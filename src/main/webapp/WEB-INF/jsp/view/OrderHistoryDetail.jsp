<!DOCTYPE html>
<html>
    <title>Order #${users[0].orderId}</title>
    <meta charset="UTF-8">
    ...
    <div class="w3-right w3-hide-small">
        ...
        <div class="w3-content w3-padding" style="max-width:1564px">
            ...
            <div class="w3-container w3-padding-32" id="about">
                <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Order #${users[0].orderId}</h3>
                <p>  
                ...
                <c:if test="${fn:length(users) > 0}">
                    ...
                    Phone No.: ${users[0].phone}<br/>
                    Delivery Address: ${users[0].address}<br/>
</h3>
