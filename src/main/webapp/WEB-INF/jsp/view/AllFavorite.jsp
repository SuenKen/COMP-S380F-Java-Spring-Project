...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="w3-container w3-padding-32" id="about">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Favorite Menu List</h3>
    <p>  
            ...
            <table border = "1"  style="font-size: 20px;" >
                <tr><th>Menu</th><th>Action</th></tr>
                    ...
                    <tr><td> ${entry.name}</td><td>
                            ...
                            [<a href="<c:url value="/menu/detail/${entry.menu_id}" />">Enter</a>] [<a href="<c:url value="/user/favorite/deletefavorite?id=${entry.menu_id}" />&username=<security:authentication property="principal.username" />">Delete</a>] 
                          </tr>
                          </security:authorize>
